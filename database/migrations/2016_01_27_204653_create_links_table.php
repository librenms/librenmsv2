...
class CreateLinksTable extends Migration {
	...
	public function up()
	{
		Schema::create('links', function(Blueprint $table)
		{
			...
			$table->integer('local_port_id')->nullable()->index();
			$table->integer('local_device_id');
			$table->integer('remote_port_id')->nullable()->index();
			...
			$table->string('remote_platform', 128);
			$table->string('remote_version', 256);
			$table->index(['local_device_id','remote_device_id']);
		});
	}
