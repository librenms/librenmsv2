...
Route::group(['middleware' => ['web']], function() {
    ...
    Route::get('widget-data/device-summary-horiz', ['uses' => 'Widgets\WidgetDataController@device_summary', 'type' => 'horiz']);
    Route::get('widget-data/device-summary-vert', ['uses' => 'Widgets\WidgetDataController@device_summary', 'type' => 'vert']);
