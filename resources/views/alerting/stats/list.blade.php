...
@section('title', trans('nav.overview.alerts.main') . ' ' .trans('nav.overview.alerts.stats'))

@section('content-header')
    <h1>
        {{ trans('nav.overview.alerts.main') }}
        <small>{{ trans('nav.overview.alerts.stats') }}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('nav.overview.alerts.stats') }}</li>
    </ol>
@endsection
